...
void  TELE_FrameA(unsigned char Buf[]) {
    ...
    src.D[0] = (INT16S)(ail_var * 2);            Buf[20] = src.B[0];                     /*[副翼舵机]*/
    src.W[0] = (INT16U)(engine_var);             Buf[21] = src.B[0];                     /*[油门开度]*/
    src.D[0] = (INT16S)(ele_var * 2);            Buf[22] = src.B[0];                     /*[升降舵机]*/
    src.D[0] = (INT16S)(rud_var * 2);            Buf[23] = src.B[0];                     /*[方向舵机]*/
    src.W[0] = (INT16U)(psi_cmd);                Buf[24] = src.B[0];                     /*[航向给定]*/
    src.D[0] = (INT16S)(theta_cmd * 2);          Buf[25] = src.B[0];                     /*[俯仰角指令]*/
    src.D[0] = (INT16S)(gama_cmd * 2);           Buf[26] = src.B[0];                     /*[滚转角指令]*/
    src.D[0] = (INT16S)((height_cmd) * 10);      Buf[27] = src.B[0]; Buf[28] = src.B[1]; /*[高度给定量]*/
    src.D[0] = (INT16S)(H_i * 10);               Buf[29] = src.B[0];                     /*[高度积分]*/
    ...
    src.W[0] = (INT16U)(theta_i * 2);            Buf[40] = src.B[0]; Buf[41] = src.B[1]; //[俯仰角积分]);   
...
void  TELE_FrameB(unsigned char Buf[]) {
    ...
    src.D[0] = (INT16S)(runtime);               Buf[26] = src.B[0]; Buf[27] = src.B[1];     /*[Runtime]）*/
    src.D[0] = (INT16S)(ac_dZ * 10);            Buf[28] = src.B[0]; Buf[29] = src.B[1];     /*[侧偏距]*/
    src.D[0] = (INT16S)(0 * 10);                Buf[30] = src.B[0]; Buf[31] = src.B[1];     /*[机场高度]*/
    src.DW = (INT32S)(ac_ax * 1e6);             Buf[32] = src.B[0]; Buf[33] = src.B[1];     /*[前向过载]*/
