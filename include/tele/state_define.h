...
extern float height_adc;                                                      //气压高度

/***********GPS信号参数***********/
extern float lon_gps;                                                         //经度
extern float lat_gps;                                                         //纬度
extern float lon_ref;                                                         //XYZ坐标系原点经度
extern float lat_ref;                                                         //XYZ坐标系原点纬度
extern float psi_init;                                                        //初始航向
extern float psi_gps;                                                         //GPS航迹角
extern float alt_gps;                                                         //GPS高度
extern float Hdot_gps;                                                        //升降速度
extern float H_acc;                                                           //GPS水平经度
extern float V_acc;                                                           //GPS垂直经度
extern float Vd_gps;                                                          //GPS地速
